...
| :--- | :--- | :--- |
| **Amazon Fraud Dashboard**<br>E-commerce fraud detection & risk analytics across 200K+ transactions. | `Power BI` `Python` `DAX` | [View Repo](https://github.com/kundanmahajankm04-collab/Amazon-fraud-Dashboard) |
| **Trader Sentiment Analysis**<br>Sentiment-driven trading signal analysis. | `Python` | [View Repo](https://github.com/kundanmahajankm04-collab/trader-sentiment-analysis) |
| **Sales Performance & Revenue Dashboard**<br>Interactive executive BI dashboard tracking multi-region KPIs, +15% visibility. | `SQL` `Power BI` `DAX` | — |
